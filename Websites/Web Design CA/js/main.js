...
function browserDetection() { 
	if(navigator.userAgent.indexOf("Chrome") != -1 ){
		document.getElementById("browser").innerHTML="Welcome Chrome User";
    }
    else if(navigator.userAgent.indexOf("Opera") != -1 ){
		document.getElementById("browser").innerHTML="Welcome OPERA User";
    }
    else if(navigator.userAgent.indexOf("Firefox") != -1 ){
       document.getElementById("browser").innerHTML=" Welcome FIREFOX User";
    }
    else if((navigator.userAgent.indexOf("MSIE") != -1 ) || (!!document.documentMode == true )){
      document.getElementById("browser").innerHTML="Welcome IE User";
    }  
    else{
       document.getElementById("browser").innerHTML="Welcome Unknown User";
    }
...
function changeImage() {
    ...
    if (image.src.match("anubis3")) {
        image.src = "images/anubis1.gif";
    } else if(image.src.match("anubis1")){
        image.src = "images/anubis2.gif";
    }
	else if(image.src.match("anubis2")){
		image.src = "images/anubis3.gif";
	}
...
function dynamicFrame() {
	...
	frames[0].location = "http://esports.smitegame.com/";
    frames[1].location = "http://esports.smitegame.com/";
}// end dynamicFrame
...
*/
function newWindow() {
    window.open("http://esports.smitegame.com/");
}//end newWindow
...
function timeDigtal(){
    ...
    document.getElementById("digtime").innerHTML="<b>" + hours + ":" + minutes + " " + ":" + seconds + " " + "</b>";
